[]{#_Toc432160086 .anchor}Оглавление
...
[2.1. Объектно-ориентированное программирование и классы 5]
...
[Иллюстрация работы 7]

[2.1.2. Задача 11.2 13]

[Условие задачи 13]

[Исходный код 16]

[Иллюстрация работы 17]

[2.1.3. Задача 11.3 20]

[Условие задачи 20]

[Исходный код 20]

[Иллюстрация работы 20]

[2.2. Стандартная библиотека 21]

[2.2.1. Задача 12.1 21]

[Условие задачи 21]

[Исходный код 22]

[Иллюстрация работы 22]

[2.2.2. Задача 12.2 23]

[Условие задачи 23]

[Исходный код 23]

[Иллюстрация работы 24]

[2.2.3. Задача 12.3 24]

[Условие задачи 24]

[Исходный код 25]

[Иллюстрация работы 25]

[3. Заключение 28]

[Список источников 29]

[]{#_Toc469871310 .anchor}1. Введение
...
-   \_\_nok\_\_(a, b) -- находит наименьшее общее кратное для переданных значений (статический метод)
...
-   form\_factor(self, value) -- \@form\_factor.setter -- метод устанавливает значение атрибута \_form\_factor
...
>
> Для решения данной задачи были модифицированы классы из Задачи 11.2. Было добавлено два метода: get\_dict(self) и from\_dict(cls, json\_data), они позволяют получить словарь из объекта и объект из словаря соответственно. Функционал данных методов был получен из части кода функций safe() и load(), поэтому кардинальных изменений кода не произошло.
>
...
-   \_\_getitem\_\_(self, k) -- возвращает элемент(ы) по индексу или по срезу

-   \_\_setitem\_\_(self, k, v) -- присваивает элемент(ы) по индексу или по срезу

-   \_\_delitem\_\_(self, k) -- удаляет элемент(ы) по индексу или по срезу
...
-   \_copy\_confirmed(self) -- запрашивает подтверждение операции (если указано в настройках)
